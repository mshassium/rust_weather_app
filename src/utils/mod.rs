...
const CURRENT_WEATHER_URL: &str =
    "https://api.openweathermap.org/data/2.5/weather?q={cityKey}&APPID={appidKey}";
const DAYTIME_WEATHER_URL: &str =
    "https://api.openweathermap.org/data/2.5/forecast?q={cityKey}&APPID={appidKey}&cnt={dayCount}";

pub fn current_weather_url(city: &str) -> String {
    let result_url: String = CURRENT_WEATHER_URL
